...

{
  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-ef2b0e2f-519e-48f7-8a46-154841ad1cb3 = [ ];
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2025,12,1,2,12,5.786";
      ...
      kactivitymanagerdrc.activities.ef2b0e2f-519e-48f7-8a46-154841ad1cb3 = "Default";
      kactivitymanagerdrc.main.currentActivity = "ef2b0e2f-519e-48f7-8a46-154841ad1cb3";
      ...
      ktrashrc."\\/home\\/lain\\/.local\\/share\\/Trash".Days = 7;
      ktrashrc."\\/home\\/lain\\/.local\\/share\\/Trash".LimitReachedAction = 0;
      ktrashrc."\\/home\\/lain\\/.local\\/share\\/Trash".Percent = 10;
      ktrashrc."\\/home\\/lain\\/.local\\/share\\/Trash".UseSizeLimit = true;
      ktrashrc."\\/home\\/lain\\/.local\\/share\\/Trash".UseTimeLimit = false;
      kwinrc.Desktops.Id_1 = "80f9ea86-0336-4508-9c98-ca76528fc555";
      kwinrc.Desktops.Number = 1;
      kwinrc.Desktops.Rows = 1;
      kwinrc.Input.TabletMode = "off";
      kwinrc.Plugins.sheetEnabled = true;
      kwinrc.Tiling.padding = 4;
      kwinrc."Tiling/80f9ea86-0336-4508-9c98-ca76528fc555/7bf50a95-61c1-44be-9f0b-e6cd61e4d35f".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/f697cd93-e214-444e-b50e-f5b09fcb6fa5/7bf50a95-61c1-44be-9f0b-e6cd61e4d35f".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///home/lain/Documents/Backup/Programming stuff/jvmflags.txt";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 1258;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 1258;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 987;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,1258,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 1234;
